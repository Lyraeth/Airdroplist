                        ...
                        <div class="row no-gutters align-items-start">
                            <div class="col-xl-2 col-md-6 mb-4 align-items-center">
                                <div class="home-img mb-4">
                                    <img src="{{ asset('profile.jpeg')}}" class="rounded-circle border border-3 border-dark" style="width: 150px; height:150px;">
                                </div>
                                <div class="col">
                            ...
                            <div class="col align-items-start text-start">
                                ...
                                <br>
                                <i class="fa-solid fa-user-clock"></i><span class="ml-2">Joined {{ Auth::user()->created_at->diffForHumans()}}</span>
                            </div>
                            <div class="col-md-3">
